...
namespace TcpUdpServer
{
    public class IOS : IPush
    {
        ...
        public IOS()
        {
            this.appkey = "57d0f6f8e0f55a1619000914";
            timestamp = JavaTime() + "";
            type = "listcast";
        }


        public IOS(string appkey, string pushtype = "listcast")
        {
            this.appkey = appkey;
            timestamp = JavaTime() + "";
            type = "listcast";
        ...
        public IOS(DeviceType deviceType)
        {
            timestamp = JavaTime() + "";
            type = "listcast";
            if (deviceType == DeviceType.YZK_IOS_APPStore)
            {
                this.appkey = "59705e55b27b0a1f27001dd2";
            }
        }



        public IOS(string pushtype)
        {
